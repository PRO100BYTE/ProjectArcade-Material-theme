...
ProjectArcade Material is a theme built totally from scratch for EmulationStation. Designed for ProjectArcade, compatible with RetroBat.
...
This theme has 16 color schemes:
...
ProjectArcade Material was made for the following resolutions:

- **480x320** (3:2 screen ratio), tested on ProjectArcade 1.5.4-beta2
- **640x480** (4:3 screen ratio), tested on RetroBat 5.1.1
- **1920x1152** (5:3 screen ratio), tested on ProjectArcade 1.5.4-beta2
...
Many thanks to the main creator of the theme - [mluizvitor](https://github.com/mluizvitor/es-theme-elementerial)
...
![Photoshop](https://img.shields.io/badge/Photoshop-273445?style=for-the-badge&logo=Photoshop&logoColor=white)
